...
#unigramtopic<-read.csv("~/VCtopicmodeling/Topics_Sorted_29July2025.csv")

#On desktop
articledata<-read.csv("~/R/VCtopicmodeling/FullExtraction_CLEAN_23July2025.csv")
unigramtopic<-read.csv("~/R/VCtopicmodeling/Topics_Sorted_29July2025.csv")
...
write.csv(unmatched_covnums,"remaining articles not matching to extraction data.csv")
...
ggsave("topictime_area_29July2025.jpg",bg="white",dpi=600,w=13.9,h=6.6)
...
ggsave("topictime_area_cumulative_29July2025.jpg",bg="white",dpi=600,w=13.9,h=6.6)
...
ggsave("topictime_bar_29July2025.jpg", bg = "white", dpi = 600, width = 13.9, height = 6.6)
```
...
# Save
ggsave("topictime_bar_cumulative_29July2025.jpg", bg = "white", dpi = 600, width = 13.9, height = 6.6)
```
...
ggsave("topicmodality_bar_counts_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
```
...
modality_topic_combos <- expand_grid(modality = unique(modality_long$modality),Topic = unique(modality_long$Topic)) 
...
#  annotate("text",
  ...
  #       y = length(unique(modality_percent$Topic)) - 9,  # top of y axis
...
#  geom_text(data = modality_percent %>% 
  ...
  scale_x_continuous(limits = c(0, 100.1), breaks=seq(0,100,25))
  
ggsave("topicmodality_stackedbar_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
...
ggsave("topiccontext_bar_counts_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
```
...
ggsave("topiccontext_stackedbar_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
```
...
ggplot(class_size_counts, aes(x = Topic, y = n, fill = class_size)) +
  geom_bar(stat = "identity") +
  labs(x = "Topic", y = expression("Articles (" * italic(n) * ")"), fill = "Class Size")+
  theme_classic(base_size = 14) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))+
...
ggsave("topicclass_size_bar_counts_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
```
...
ggsave("topicstudlevel_bar_counts_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
```
...
ggsave("topicstudlevel_stackedbar_29July2025.jpg", bg = "white", dpi = 600, width = 9, height = 5.49)
```
...
ggsave("topicmajor_bar_counts_29July2025.jpg", bg = "white", dpi = 600, width = 7.29, height = 5.49)
```
...
ggsave("topicmajor_stackedbar_29July2025.jpg", bg = "white", dpi = 600, width = 9, height = 5.49)
```